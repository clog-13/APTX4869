...
func WithCancel(parent Context) (ctx Context, cancel CancelFunc) {
	...
	return &c, func() { c.cancel(true, Canceled) } // func (c *cancelCtx) cancel(removeFromParent bool, err error)
}
...
func removeChild(parent Context, child canceler) {
	p, ok := func(parent Context) (*cancelCtx, bool) { // parentCancelCtx(parent Context)
		done := parent.Done()
...
由于 context 包的代码并不多，在 else 语句里加上了几条打印语句，来验证上面的说法：

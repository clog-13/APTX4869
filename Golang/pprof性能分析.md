...
想度量应用程序的 CPU 性能数据，只需要在 main 函数中添加 2 行代码即可：
...
如果提示 Graphviz 安装，则需要安装。

访问 `localhost:9999`，可以看到这样的页面：

![bubble sort pprof](https://geektutu.com/post/hpg-pprof/bubble-sort-pprof.jpg)
...
![concat memory pprof](https://geektutu.com/post/hpg-pprof/concat-mem-pprof.jpg)
